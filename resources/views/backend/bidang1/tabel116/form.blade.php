<div class="col-xs-12">
  <div class="box">
    <div class="box-body ">
        ...
        <div class="form-group {{ $errors->has('belum') ? 'has-error' : '' }}">
            {!! Form::label('belum lulus') !!}
            {!! Form::text('belum', null, ['class' => 'form-control']) !!}

            @if($errors->has('belum'))
                <span class="help-block">{{ $errors->first('belum') }}</span>
            @endif
        </div>
