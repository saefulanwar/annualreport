<div class="col-xs-12">
  <div class="box">
    <div class="box-body ">
        ...
        <div class="form-group {{ $errors->has('status_hki') ? 'has-error' : '' }}">
            {!! Form::label('status_hki') !!}
            {!! Form::text('status_hki', null, ['class' => 'form-control']) !!}

            @if($errors->has('status_hki'))
                <span class="help-block">{{ $errors->first('status_hki') }}</span>
            @endif
        </div>
