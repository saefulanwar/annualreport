<div class="col-xs-12">
  <div class="box">
    <div class="box-body ">
        ...
        <div class="form-group {{ $errors->has('sbrdana') ? 'has-error' : '' }}">
            {!! Form::label('sbrdana') !!}
            {!! Form::text('sbrdana', null, ['class' => 'form-control']) !!}

            @if($errors->has('sbrdana'))
                <span class="help-block">{{ $errors->first('sbrdana') }}</span>
            @endif
        </div>
