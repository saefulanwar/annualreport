        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box-header">
              <div class="pull-left">
                <a href="{{ route('tabel188.create') }}" class="btn btn-success"><i class="fa fa-pencil"></i> Add New</a>
              </div>   
            </div>        
              <!-- /.box-header -->
              <div class="box-body ">
               @include('backend.partials.message')
                    ...
                    @else                       
                        @include('backend.bidang1.tabel188.table')
                    @endif
              </div>
              <!-- /.box-body -->
              <div class="box-footer clearfix">
                ...
                <div class="pull-right">
                    <small>{{ $tabel188Count }}{{ str_plural(' Item', $tabel188Count) }}</small>
                </div>
              </div>
            </div>
            <!-- /.box -->
